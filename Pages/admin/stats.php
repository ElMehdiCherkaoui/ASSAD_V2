    ...
    $totalVisitors = $userModel->countUsers();
    $visitorsByCountry = $userModel->totalVisitorsByCountry();
    ?>
    <!DOCTYPE html>
    <html lang="en">
        ...
        <main class="ml-60 p-8">
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-4">
                <div class="bg-white p-6 rounded-xl shadow">
                    ...
                    <p id="totalVisitors" class="text-3xl font-bold text-gray-800 mt-2"><?php echo $totalVisitors; ?>
                    </p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow">
                    <p class="text-sm text-gray-500">Animals</p>
                    <p id="totalAnimals" class="text-3xl font-bold text-gray-800 mt-2"><?php echo $totalAnimals; ?></p>
                </div>
            </section>
            ...
            <div class="mt-8">
                ...
                <table class="min-w-full bg-white shadow rounded">
                    ...
                    <tbody id="visitorsByCountry">
                        ...
                        <tr>
                            <td class="px-4 py-2"><?php echo $country['country']; ?></td>
                            <td class="px-4 py-2"><?php echo $country['total']; ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
